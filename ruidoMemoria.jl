...
noise1 = corrigeRuidoToledo(usuarioxitemTreino,usuarioxitemTeste,4)
U,V = rsvdTrainBase(usuarioxitemTreino,treinamento1,96)
rmse,predicts = rsvdRmse(U,V,teste1,usuarioxitemTeste)
println("Rmse sem corrigir $rmse")

U,V = rsvdTrainBase(noise,treinamento1,96)
rmse,predicts = rsvdRmse(U,V,teste1,usuarioxitemTeste)
println("Rmse Mahone $rmse")

U,V = rsvdTrainBase(noise1,treinamento1,96)
rmse,predicts = rsvdRmse(U,V,teste1,usuarioxitemTeste)
println("Rmse Toledo $rmse")
